...
// Size of rate-gate table for identity verification (indexed by InetAddress.rateGateHash() % this)
#ifndef ZT_LAST_IDENTITY_VERIFICATION_SIZE
#define ZT_LAST_IDENTITY_VERIFICATION_SIZE 16384
#endif
...
class Node : public NetworkController::Sender {
  public:
	...
	{
		unsigned long iph = from.rateGateHash() % ZT_LAST_IDENTITY_VERIFICATION_SIZE;
  ...
  public:
	...
	// Time of last identity verification indexed by InetAddress.rateGateHash() % ZT_LAST_IDENTITY_VERIFICATION_SIZE
	int64_t _lastIdentityVerification[ZT_LAST_IDENTITY_VERIFICATION_SIZE];
